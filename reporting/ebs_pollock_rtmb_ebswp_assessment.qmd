...
spmr_detail_file <- file.path(display_path(spmr_projection$output_dir), "spm_detail.csv")
spmr_summary_file <- file.path(display_path(spmr_projection$output_dir), "spm_summary.csv")
